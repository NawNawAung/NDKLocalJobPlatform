<template>
    <footer class="site-footer bg-[var(--brand-ink)] text-slate-300">
        <div class="mx-auto flex max-w-[1440px] flex-col gap-7 px-5 py-8 sm:px-8 lg:flex-row lg:items-center lg:justify-between">
            <div>
                <a href="#home" class="inline-flex items-center text-white" aria-label="NDK Myanmar home"><img :src="'/images/brand/NDKJobPlatformLogo.jpeg'" alt="NDK Myanmar" class="h-12 w-auto max-w-52 object-contain" /></a>
