<template>
    <footer class="site-footer bg-[var(--brand-ink)] text-slate-300">
        <div class="mx-auto flex max-w-[1440px] flex-col gap-7 px-5 py-8 sm:px-8 lg:flex-row lg:items-center lg:justify-between">
            <div>
                <a href="#home" class="inline-flex items-center gap-2 text-white"><span class="grid h-8 w-8 place-items-center rounded-md bg-[var(--brand-primary)] text-xs font-extrabold">N</span><strong class="text-base tracking-tight">NDK</strong></a>
